...
CREATE TABLE IF NOT EXISTS `hm_activity` (
...
CREATE TABLE IF NOT EXISTS `hm_admin` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `hm_admin` (`id`, `admin_name`, `admin_password`, `role_id`, `is_effect`, `login_time`, `login_ip`) VALUES
...
CREATE TABLE IF NOT EXISTS `hm_city` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `hm_company` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(255) NOT NULL COMMENT '标题',
  `vice-heading` varchar(255) NOT NULL COMMENT '副标题',
...
CREATE TABLE IF NOT EXISTS `hm_msg_box` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `hm_product` (
  ...
  `all_store` int(11) NOT NULL COMMENT '店铺0:全球购店铺1:天猫美妆2:天猫国际',
...
INSERT INTO `hm_product` (`id`, `title`, `vice_heading`, `activity`, `city`, `all_store`, `add_time`, `img`, `collect_status`) VALUES
(1, '1', '', '<p>说22&nbsp;</p>', 2, 1, 1498060800, '20170630\\c913a36d913d5993d89da061bff645f0.png', NULL),
(2, '111', '', NULL, 0, 0, 1498752000, '20170629\\0a7921cf94322f0e7cef74aeabb6ef32.jpg', NULL),
(3, 'ZELENS,均匀肤色清爽养肤', '', NULL, 0, 0, 1498665600, '20170629\\70ba00f52ae7e22e20e6e1e9f6abd1d6.png', NULL),
(4, '122', '', NULL, 0, 0, 1498665600, '20170629\\9700c429bff251d2a3f5a5898df73541.png', NULL),
(5, '美妆', '', '<p>456456kuuk</p>', 0, 1, 1498665600, '20170629\\99bdf0083b668f55af4edd994e09cdcf.png', NULL),
(6, 'ZELENS,均匀肤色清爽养肤', '', '<p>ZELENS,均匀肤色清爽养肤</p>', 0, 0, 1498665600, '20170629\\30ee118f7a1b029ee96e54589054d02c.png', NULL),
(7, '123', '456', '<p>784556</p>', 2, 2, 1498060800, '20170629\\fcd050e73c9e8476c4c4a91357d40492.png', NULL);
...
CREATE TABLE IF NOT EXISTS `hm_role` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `hm_role` (`id`, `name`) VALUES
(1, 'huamei'),
(2, '111'),
(3, '111'),
(4, '111');
...
CREATE TABLE IF NOT EXISTS `hm_role_access` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 转存表中的数据 `hm_role_access`
--

INSERT INTO `hm_role_access` (`id`, `role_id`, `node`, `controller`) VALUES
(1, 1, '', ''),
(2, 4, 'Order', 'close'),
(3, 4, 'Order', 'edit'),
(4, 4, 'Goods', 'add'),
...
CREATE TABLE IF NOT EXISTS `hm_substance` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- 表的结构 `hm_user_collect`
--

CREATE TABLE IF NOT EXISTS `hm_user_collect` (
